...
export default function PaymentHistory({ 
  ...
  const exportMutation = trpc.payments.exportToPDF.useMutation();
  ...
  const handleExportPDF = async () => {
    ...
    try {
      setIsExporting(true);
      console.log("Iniciando exportación de PDF para cliente:", clientId);
      ...
      <CardHeader className="flex flex-row items-center justify-between">
        ...
        {filteredPayments.length > 0 && (
          ...
          >
            ...
            {isExporting || exportMutation.isPending ? "Generando..." : "Descargar PDF"}
          </Button>
        )}
      </CardHeader>
